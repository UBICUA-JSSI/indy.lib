...
public enum ErrorCode {
    ...
    /**
     * Attempt to create pool ledger config with name used for another existing
     * pool
     */
    ...
    /**
     * Attempt to open Pool for witch Genesis Transactions are not compatible
     * with set Protocol version. Call pool.indy_set_protocol_version to set
    ...
    private int value;
    private static final Map<Integer, ErrorCode> map = new HashMap<Integer, ErrorCode>();
